...
import { AlienMaxAnalyticsInsight } from "@/lib/repositories/googleAnalyticsRepository";
import { BotIcon, ArrowUpRightIcon } from "@/components/icons";

export interface AlienMaxAnalyticsAdvisorWidgetProps {
  insights: AlienMaxAnalyticsInsight[];
}

export function AlienMaxAnalyticsAdvisorWidget({
  insights,
}: AlienMaxAnalyticsAdvisorWidgetProps) {
  return (
    <Card className="border-[#E4E4E7] bg-white space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#111111] tracking-tight">
              Alien Max · Consultor de Analytics (GA4)
            </h3>
            <span className="text-[10px] text-[#71717A] block">
              Auditoria de Tráfego & Comportamento
            </span>
          </div>
        </div>
      ...
      <p className="text-xs text-[#52525B] leading-relaxed">
        O Alien Max apenas recomenda. <strong className="text-[#111111]">Nenhuma meta ou código de rastreamento é alterado automaticamente.</strong>
      </p>
