...
import { AlienMaxProjectInsight } from "@/lib/repositories/projectRepository";
import { BotIcon, ArrowUpRightIcon } from "@/components/icons";

export interface AlienMaxProjectAdvisorWidgetProps {
  insights: AlienMaxProjectInsight[];
}

export function AlienMaxProjectAdvisorWidget({
  insights,
}: AlienMaxProjectAdvisorWidgetProps) {
  return (
    <Card className="border-[#E4E4E7] bg-white space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#111111] tracking-tight">
              Alien Max · Consultor de Projetos
            </h3>
            <span className="text-[10px] text-[#71717A] block">
              Gargalos, Prazos & Entregáveis
            </span>
          </div>
        </div>
      ...
      <p className="text-xs text-[#52525B] leading-relaxed">
        O Alien Max apenas recomenda. <strong className="text-[#111111]">Nenhum prazo ou projeto é alterado sem confirmação humana.</strong>
      </p>
