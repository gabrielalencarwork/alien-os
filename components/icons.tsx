...
export function AlienLogoIcon({ className = "w-6 h-6", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <circle cx="9" cy="11" r="2" fill="#4A8237" />
      <circle cx="15" cy="11" r="2" fill="#4A8237" />
      <path
        d="M8 16C9.5 17.2 14.5 17.2 16 16"
        stroke="#4A8237"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function LayoutDashboardIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function RocketIcon({ className = "w-5 h-5", ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9 12H4.5s.5-3.5 3-4.5" />
      <path d="M12 9v-4.5s3.5.5 4.5 3" />
    </svg>
  );
}
...
export function CheckCircle2Icon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function TrophyIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CommandIcon({ className = "w-3.5 h-3.5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function Maximize2Icon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function Minimize2Icon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function KeyIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21 2-2 2m-1.5 1.5L14 9a5 5 0 1 0 3 3l3.5-3.5M16 6l2 2" />
    </svg>
  );
}

export function SaveIcon({ className = "w-4 h-4", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
